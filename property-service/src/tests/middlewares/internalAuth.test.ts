...
describe("Internal Service Authentication Middleware - Property Service", () => {
  ...
  beforeEach(() => {
    ...
    process.env = {
      ...
      ALLOWED_SERVICES: "booking-service,user-service"
    };
  ...
  describe("Valid Token", () => {
    ...
    it("should allow request from user-service", () => {
      (mockRequest.headers as Record<string, string>)["x-internal-service-token"] = "valid.jwt.token";
